...
public class DateUtil {
    ...
    public static Date convertDate(Date date, TimeZone src, TimeZone dst) {
        long time = date.getTime() - src.getRawOffset() + dst.getRawOffset();
        return new Date(time);
    }

    public static Date convertDate(Date date, TimeZone dst) {
        TimeZone src = TimeZone.getDefault();
        return convertDate(date, src, dst);
    }

    public static Date convertDate(Date date, String srcID, String dstID) {
        TimeZone src = TimeZone.getTimeZone(srcID);
        TimeZone dst = TimeZone.getTimeZone(dstID);
        return convertDate(date, src, dst);
    }

    public static Date convertDate(Date date, String dstID) {
        TimeZone dst = TimeZone.getTimeZone(dstID);
        return convertDate(date, dst);
    }
