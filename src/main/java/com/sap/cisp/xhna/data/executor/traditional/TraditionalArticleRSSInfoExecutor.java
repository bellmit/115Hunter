...
public class TraditionalArticleRSSInfoExecutor extends AbstractTaskExecutor {

    @Override
    public List<String> execute(Map<String, Object> ctx) throws Exception {
        TraditionalArticleRSSExecutor executor = new TraditionalArticleRSSExecutor();
    ...
    public static void main(String[] args) {
        ...
        params.put("media_name", "csmonitor");
        params.put("task_key", "http://rss.csmonitor.com/feeds/csm");
//        params.put("task_key", "http://www.nytimes.com/services/xml/rss/nyt/World.xml");
        ...
        ITask task = TaskFactory
                ...
                .createTask(
                        ...
                        "csmonitor", param);
        ctx.put("task", task);
        TraditionalArticleRSSInfoExecutor exe = new TraditionalArticleRSSInfoExecutor();
        exe.setTask(task);
