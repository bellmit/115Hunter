...
public class DatasiftStreamKeywordExecutor extends AbstractTaskExecutor {
    private static Logger log = LoggerFactory
            .getLogger(DatasiftStreamKeywordExecutor.class);
    private static final SimpleDateFormat sdf = new SimpleDateFormat(
            "yyyy-MM-dd'T'HH:mm:ss+0000");
    private static final TimeZone GMT = TimeZone.getTimeZone("GMT");
    private Date from;
    private Date to;
    private String CSDL_KEYWORD_PREFX_FORMAT = "interaction.type == \"%s\" and interaction.content contains_any [language(%s)] \"%s\"";
    protected String interactionType = "tencentweibo";
    protected String interactionLang = "zh";
    ...
    public List<String> execute(Map<String, Object> ctx)
        ...
        return getResultsByKeyword(ctx, keyword, startTime, endTime);
    }
    ...
    protected List<String> getResultsByKeyword(Map<String, Object> ctx,
        ...
        String csdl = String.format(CSDL_KEYWORD_PREFX_FORMAT, interactionType,
...
//              DatasiftUtils.subscirbeDummyStreamWithCSDL(csdl, queue);
        ...
        while (!isCanceled) {
            ...
            if (interaction != null && interaction.getData() instanceof BooleanNode
...
//            batchWriter.addResult(interaction.getData().toString());
        ...
        //Need to unsubscribe the stream
    ...
    public static void main(String[] args) {
        ...
        ITask task = TaskFactory
                ...
                .createTask(
                        ...
                        "Tencentweibo", param);
        ctx.put("task", task);
        DatasiftStreamKeywordExecutor exe = new DatasiftStreamKeywordExecutor();
